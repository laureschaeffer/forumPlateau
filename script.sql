...
INSERT INTO `post` (`id_post`, `texte`, `dateCreation`, `user_id`, `topic_id`) VALUES
	...
	(3, 'I think one of my favorite are the one with mozzarella, tomatoes and basil. Theyre obviously from Italy.', '2024-03-20 10:47:03', 1, 3),
	...
	(7, 'Im so fascinated and admirating about artificial intelligence progress!', '2024-03-22 15:00:00', 2, 19),
...
INSERT INTO `topic` (`id_topic`, `titre`, `dateCreation`, `verouillage`, `category_id`, `user_id`) VALUES
	...
	(20, 'Lart du XXIe siècle', '2024-03-21 09:45:00', 0, 1, 3),
